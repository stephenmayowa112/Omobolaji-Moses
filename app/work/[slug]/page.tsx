    ...
    <>
      ...
      <article className="w-full flex flex-col gap-8 sm:gap-12 md:gap-16 pb-8 sm:pb-12">
        ...
        <div className="relative w-full aspect-[1691/606] max-h-[606px] bg-neutral-900 overflow-hidden flex items-center justify-center p-4 text-center rounded-sm">
          ...
          {project.logoImage && (
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-20 w-[90%] sm:w-[70%] md:w-[60%] lg:w-[50%] max-w-[854px]">
              <Image
                src={project.logoImage}
                alt={`${project.title} Logo`}
                width={854}
                height={192}
                className="w-full h-auto aspect-[854/192] object-contain drop-shadow-2xl opacity-100 border-[5px] border-transparent"
                priority
              />
            </div>
          )}
